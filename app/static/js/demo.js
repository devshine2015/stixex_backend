    ...
    var skin_black =
        $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
            .append("<a href='javascript:void(0);' data-skin='skin-black' style='display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)' class='clearfix full-opacity-hover'>"
                + "<div style='box-shadow: 0 0 2px rgba(0,0,0,0.1)' class='clearfix'><span style='display:block; width: 20%; float: left; height: 7px; background: #1a2226;'></span><span style='display:block; width: 80%; float: left; height: 7px; background: #1a2226;'></span></div>"
...
$.get("/pending_withdraw_count", function (data) {

    $(".withdraws-menu-item a").first().append(
        $('<span class="pull-right-container"><small class="label pull-right bg-green">' + data + '</small></span>'));

});
$("input[name='search']").first()[0].style.cssText = "margin-top: 2.5px;";
